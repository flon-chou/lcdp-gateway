...
To build the final jar and optimize the LcdpGateway application for production, run:
...
Then navigate to [http://localhost:28080](http://localhost:28080) in your browser.
